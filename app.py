...
localization_dict = {
    ...
    "Face": 5, "Chest": 6, "Foot": 7, "Unknown": 8, "Neck": 9, "Scalp": 10, "Hand": 11,
    "Ear": 12, "Genital": 13, "Acral": 14
}
metadata = [age, gender_dict[gender], localization_dict[localization]]

if uploaded_file and st.button('Analyze Lesion'):
    image = Image.open(uploaded_file)
    masked_image, lesion_type, output, pred_index, max_prob = mask_and_predict(image, fusion_model, metadata, 'cpu')
